...
- Keep credentials and runtime state in the existing ChatEnv profiles and ChatArch home. Never store secrets in the repository, task artifacts, logs, or package distributions.
